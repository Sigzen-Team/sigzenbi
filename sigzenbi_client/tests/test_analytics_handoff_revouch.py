...
"analytics SSO is not working sometimes").
...
does not reach the analytics server.
"""
import ast
import inspect
import textwrap
...
class TestHandoffRecoversAStaleSession(FrappeTestCase):
    ...
    def test_identity_comes_from_the_resolver_and_NOT_from_the_cookie(self):
        ...
        grants a LOGIN. Measured before the fix: sign in as an analyst, switch the ERP session to a viewer, click Open Analytics -> signed in as the analyst.
