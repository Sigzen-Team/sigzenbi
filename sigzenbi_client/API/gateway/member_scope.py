...
list, per doctype, and Central caches it for the analytics template processor to inject.
...
def _permitted_fields(doctype, member_email, parent):
	...
	# EVERY NAME HERE MUST BE A REAL COLUMN. This list is not advisory -- the analytics
