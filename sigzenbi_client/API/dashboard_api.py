...
def get_superset_token(dashboard_id=None):
    ...
    try:
        ...
        # this tenant's Superset embeds for THIS domain (SaaS per-tenant embed authorization).
        # Prefer the Origin header (exactly what Superset's allowed_domains checks); fall back to
