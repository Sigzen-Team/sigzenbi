...
Open Analytics -> **signed in as the analyst**. A viewer inheriting an analyst's analytics
...
WHY IT RE-VOUCHES (founder: "analytics SSO is not working sometimes", 2026-08-09)
...
hand-off does not reach the analytics server.
